...
## <b id="0"> ❓ 어떤 프로젝트인가요?</b>
- 오픈 API를 활용해보고 싶었고 학습했던 웹 개발 능력을 키우기 위해 이 프로젝트를 진행하게 되었습니다.
...
- 그래서 테이블/좌석을 실시간으로 확인할 수 있는 서비스를 생각했고
  ...
  식당만이 아닌 테이블/좌석만 있다면 모든 이용시설로 대중화 되었을 때
...
### 1. 깃 브랜치 전략
- 실무 개발처럼 협업한 경험이 없어서 이러한 경험을 간접적으로 해보기 위해
  
  이번 개인 프로젝트에서 각 도메인의 브랜치를 생성하여 깃 브랜치 전략을 적용해보았습니다.
